...
namespace TEST_VERIFICA_NOVEMBRE_DIMASI
{
    ...
    public class TestAthlete
    {
        ...
        {
            Session s1 = new Session(1, 10, 15, false);
            Session s2 = new Session(5, 10, 15, true);
        ...
        public void IsNewSessionBetter_WithValidValues_IsCorrectUpdate()
        {
            ...
            Session newS1 = new Session(3, 28, 9, false);
            Session newS2 = new Session(6, 24, 15, true);
        ...
        {
            Session s1 = new Session(3, 10, 15, false);
            Session s2 = new Session(6, 10, 15, true);

            Athlete athlete = new Athlete(1, "Test", s2, s1);

            Session newS1 = new Session(1, 28, 9, false);
            Session newS2 = new Session(4, 24, 15, true);
