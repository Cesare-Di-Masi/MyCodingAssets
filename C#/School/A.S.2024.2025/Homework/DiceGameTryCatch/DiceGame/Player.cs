    ...
    public class Player
    {
        ...
        public int Score 
        {
            ...
            set
            {
                ...
                //non posso assegnare un n uovo valore di score più piccolo del precedente se lo score è maggiore di zero (ho già giocato)
                if (value <= _score && _score>0 ) throw new ArgumentOutOfRangeException("illegal score ..");
                _score = value;
            }
        }
