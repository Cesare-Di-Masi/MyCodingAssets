...
{
    /// <summary>
    /// Logica di interazione per AdoptionManagerWindow.xaml
    /// </summary>
    public partial class AdoptionManagerWindow : Window
    {
        public CatteryService CatteryService;

        public AdoptionManagerWindow(CatteryService cattery)
        {
            InitializeComponent();
