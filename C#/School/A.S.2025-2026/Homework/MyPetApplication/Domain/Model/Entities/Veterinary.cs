...
namespace Domain.Model.Entities
{
    public class Veterinary
    {
        ...
        public Veterinary(FullName name, Email email, PhoneNumber phone, string specialization = null)
        {
            Name = name;
            Email = email;
            Phone = phone;
        ...
        public Veterinary(string name, string surname, string email, string phone, string specialization = null)
            : this(new FullName(name, surname), new Email(email), new PhoneNumber(phone), specialization) { }
